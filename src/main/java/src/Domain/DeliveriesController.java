...
import src.DTO.*;
import src.DataAccess.DAO.DocumentDAOImpl;
import src.DataAccess.DAO.ShipmentItemDAOImpl;
import src.DataAccess.EmployeeDAO.DriverDAOImpl;
import src.DataAccess.EmployeeDAO.ShiftAssignmentDAOImpl;
import src.DataAccess.EmployeeInterface.DriverDAO;
import src.DataAccess.EmployeeInterface.ShiftAssignmentDAO;
import src.DataAccess.Interface.DocumentDAO;
import src.DataAccess.Interface.ShipmentItemDAO;
import src.Domain_employee.Driver;
import src.Domain_employee.Employee;

import java.sql.SQLException;
import java.util.*;

import static src.Domain.DriverController.employeeDAO;
import static src.Domain.LocationController.locationDao;
import static src.Domain.TrucksController.truckDAO;
