...
public class Location {
    ...
    private DomainDelivery.Shipping_Zone zone; // Shipping zone to which the location belongs
    private List<DomainDelivery.Shipment_item> items_required; // List of shipment items required at this location

    // Constructor
    public Location(String contact_name, String contact_num, String address, DomainDelivery.Shipping_Zone zone) {
    ...
    public DomainDelivery.Shipping_Zone getZone() {
        return zone;
    }
    ...
    public List<DomainDelivery.Shipment_item> getItems_required() {
