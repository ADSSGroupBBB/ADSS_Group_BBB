...
public class Document {
    private List<DomainDelivery.Shipment_item> items; // List of items being shipped
    ...
    private List<DomainDelivery.Location> destinations; // List of destination locations
     ...
     */
    public Document(List<DomainDelivery.Shipment_item> items, String date, String truck_id,
    ...
    public List<DomainDelivery.Shipment_item> getItems() {
        return items;
    }
    ...
    public List<DomainDelivery.Location> getDestinations() {
        return destinations;
    }
